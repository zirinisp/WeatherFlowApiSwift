...
open class Profile {
    ...
    convenience public init(dictionary: [String : Any]) {
        ...
        master = BoolConverter.convert(dictionary["master"])
        alerts_enabled = BoolConverter.convert(dictionary["alerts_enabled"])
        ...
        my_profile = BoolConverter.convert(dictionary["my_profile"])
