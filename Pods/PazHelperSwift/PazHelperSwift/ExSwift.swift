...
public class ExSwift {
    ...
    */
    public class func after <P, T> (n: Int, function: @escaping (P...) -> T) -> ((P...) -> T?) {
    ...
    */
    ...
    - returns: Wrapper function
    */
    public class func once <P, T> (function: @escaping (P...) -> T) -> ((P...) -> T) {
    ...
    */
    ...
    - returns: Wrapper function
    */
    public class func partial <P, T> (function: @escaping (P...) -> T, _ parameters: P...) -> ((P...) -> T) {
        typealias Function = ([P]) -> T
    ...
    - returns: Wrapper function
    */
    public class func bind <P, T> (function: @escaping (P...) -> T, _ parameters: P...) -> ((Void) -> T) {
        typealias Function = ([P]) -> T
    ...
    - returns: Wrapper function
    */
    public class func cached <P: Hashable, R> (function: @escaping (P) -> R) -> ((P) -> R) {
        var cache = [P:R]()
    ...
    - returns: Wrapper function
    */
    public class func cached <P: Hashable, R> (function: @escaping (P...) -> R, hash: @escaping ((P...) -> P)) -> ((P...) -> R) {
    ...
    */
    public class func cached <P: Hashable, R> (function: @escaping (P...) -> R) -> ((P...) -> R) {
        return cached(function: function, hash: { (params: P...) -> P in return params[0] })
    }
